      ...
      <View style={styles.itemRow}>
        ...
        <View style={styles.qtyControls}>
          <Pressable
            style={styles.qtyBtn}
            onPress={() =>
              updateQuantity(item.product.local_id, item.quantity - 1)
            }
          >
            <Minus size={14} color={colors.text} />
          </Pressable>
          <AppText variant="bodySemibold" style={styles.qtyValue}>
            {item.quantity}
          </AppText>
          <Pressable
            style={styles.qtyBtn}
        ...
        <Pressable
          onPress={() => removeItem(item.product.local_id)}
          hitSlop={8}
        >
        ...
        <View style={styles.fieldGroup}>
          ...
          >
            <View style={styles.dropdownLeft}>
              <UserCheck
                size={16}
                color={handlerEmployeeId ? colors.primary : colors.textMuted}
              />
              <AppText
                variant="body"
                style={
                    ...
                    >
                      <View>
                        <AppText
                          variant="body"
                          style={
                            selected ? styles.pickerTextSelected : undefined
                          }
                        >
                          {emp.name}
                        </AppText>
          ...
          <PaymentOption
            icon={
              <Banknote
                size={18}
                color={
                  paymentMethod === "cash" ? colors.textInverse : colors.text
                }
              />
            }
            label="Tunai"
          ...
          <PaymentOption
            icon={
              <QrCode
                size={18}
                color={
                  paymentMethod === "qris" ? colors.textInverse : colors.text
                }
              />
            }
            label="QRIS"
  ...
  return (
    ...
    >
      ...
      <AppText
        ...
        style={
          selected
            ? { ...styles.paymentLabel, color: colors.textInverse }
            : styles.paymentLabel
        }
      >
        {label}
